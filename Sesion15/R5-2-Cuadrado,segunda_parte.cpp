...
/*	Programa que usando el programa anterior comprobar si un cuadrado 
	contiene a otro.
*/
...
class Cuadrado{
	...
	public:
   	...
   	Punto2D Centro(){
      	Punto2D centro_cuadrado(esquina_abscisa + longitud/2, esquina_ordenada + longitud/2);
      	
      	return centro_cuadrado;
   	}

   	Circunferencia CircunferenciaInscrita(){
   		Punto2D centro_circulo = Centro();
      	Circunferencia cir_inscrita(centro_circulo.Abscisa(), centro_circulo.Ordenada(), longitud/2);
   	...
   	Circunferencia CircunferenciaCircunscrita(){
   		Punto2D centro_circulo = Centro();
      	SegmentoDirigido radio_circunscrito(esquina_abscisa, esquina_ordenada,
                  	  								centro_circulo.Abscisa(), centro_circulo.Ordenada());
         
         Circunferencia cir_circunscrita(centro_circulo.Abscisa(), centro_circulo.Ordenada(), radio_circunscrito.Longitud());
         
         return cir_circunscrita;
   	}
   	...
   	bool Contiene(Cuadrado otro){
      	return MayorArea_que(otro) && esquina_abscisa <= otro.esquina_abscisa && esquina_ordenada <= otro.esquina_ordenada
					 && (esquina_abscisa+longitud) >= (otro.esquina_abscisa+otro.longitud)
      			 && (esquina_ordenada+longitud) >= (otro.esquina_ordenada+otro.longitud);
   	}
};
...
int main(){
   ...
   Circunferencia circunf_interior_cuadrado(cuadrado_A.CircunferenciaInscrita());			//Constructores de copia
   ...
   Punto2D centro(cuadrado_B.Centro());			//Constructor de copia
