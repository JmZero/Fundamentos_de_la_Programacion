/*	Programa que leera una cadena de enteros y
	calculara el número de secuencias ascendentes
...
class SecuenciaEnteros {
	...
	public:					//Métodos publicos de la clase
		...
		/*Método para calcular cuantas cadenas ascendentes hay en el vector*/
...
int main(){
	SecuenciaEnteros una_secuencia;		//Declaración del objeto
